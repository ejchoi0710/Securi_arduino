...
const char* ssid = "SK_WiFiGIGA2A98";
const char* password = "1810000573";

//https://console.firebase.google.com/project/xxxxxxxxxx/settings/serviceaccounts/databasesecrets
String FIREBASE_HOST = "https://securi-f4c0d.firebaseio.com/";
String FIREBASE_AUTH = "aL53gG5Y0esOemRmox1ED7MRY8kYRk0fmuC7uKbB";
